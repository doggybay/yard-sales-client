...
export const fetchAllSales = () => {
  ...
  return async (dispatch) => {
    try {
      ...
      const res = await axios.get(`${BASE_URL.homeH}/sales`)
...
export const fetchOneSale = (id) => {
  ...
  return async (dispatch) => {
    try {
      ...
      const res = await axios.get(`${BASE_URL.homeH}/sales/${id}`)
...
export const editSale = (id) => {
  ...
  return async (dispatch) => {
    try {
      ...
      const res = await axios.patch(`${BASE_URL.homeH}/sales/${id}`)
...
export const addNewSale = () => {
  return async (dispatch) => {
    try {
      ...
      const res = await axios.post(`${BASE_URL.homeH}/sales`)
...
export const deleteSale = () => {
  return async (dispatch) => {
    try {
      ...
      const res = await axios.delete(`${BASE_URL.homeH}/sales`)
